...
from shuttlebusTrainIntensity import drivePointMamba
...
if __name__ == "__main__":
    ...
    parser.add_argument("model_name", default="pointMambaIntensity_shuttle_lane_following_23_0.0015_0.6472_0.7535.pth", type=str, nargs='?')
