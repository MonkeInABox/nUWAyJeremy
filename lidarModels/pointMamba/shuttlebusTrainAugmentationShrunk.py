...
if __name__ == "__main__":
    ...
    batch_size = 70
    npoints = 1536 #3072
    points_all = 2600 #4300
    best_loss = 100000

    model_path_name = "pointMambaAugmentedLateralShrunk_shuttle_lane_following_32_0.0011_0.6982_0.7891.pth"
    checkpoint = None
    ...
    for epoch in range(start_epoch, epochs):
        ...
        if best_loss > total_epoch_loss:
            ...
            save_name = f"pointMambaAugmentedLateralShrunk_shuttle_{model_name}_{epoch+1}_{total_epoch_loss:.4f}_{total_epoch_accuracy1:.4f}_{total_epoch_accuracy2:.4f}.pth"
    ...
    torch.save(model.state_dict(), f'pointMambaAugmentedLateralShrunk_shuttle_{model_name}.pth')
    writer.flush()
    writer.close()
