...
if __name__ == "__main__":
    ...
    for epoch in range(start_epoch, epochs):
        ...
        if best_loss > total_epoch_loss:
            ...
            save_name = f"pointMambaAugmentedLateral_shuttle_{model_name}_{epoch+1}_{total_epoch_loss:.4f}_{total_epoch_accuracy1:.4f}_{total_epoch_accuracy2:.4f}.pth"
    ...
    torch.save(model.state_dict(), f'pointMambaAugmentedLateral_shuttle_{model_name}.pth')
    writer.flush()
    writer.close()
