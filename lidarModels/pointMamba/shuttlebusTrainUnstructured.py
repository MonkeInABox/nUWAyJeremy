...
if __name__ == "__main__":
    ...
    model_path_name = "unstructured_pointMamba_shuttle_lane_following_47_0.0011_0.7246_0.8069.pth"
    checkpoint = None
    ...
    scheduler = ReduceLROnPlateau(optimizer, 'min', factor=gamma, patience=3, threshold=1e-4, threshold_mode='abs', verbose=True)
    ...
    for epoch in range(start_epoch, epochs):
        ...
        if best_loss > total_epoch_loss:
            ...
            save_name = f"unstructured_pointMamba_shuttle_{model_name}_{epoch+1}_{total_epoch_loss:.4f}_{total_epoch_accuracy1:.4f}_{total_epoch_accuracy2:.4f}.pth"
    ...
    torch.save(model.state_dict(), f'unstructured_pointMamba_shuttle_{model_name}.pth')
    writer.flush()
    writer.close()
