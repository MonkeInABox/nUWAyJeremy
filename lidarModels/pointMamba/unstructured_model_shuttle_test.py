...
from shuttlebusTrainUnstructured import drivePointMamba
...
if __name__ == "__main__":
    ...
    parser.add_argument("model_name", default="unstructured_pointMamba_shuttle_lane_following_50_0.0011_0.7327_0.8118.pth", type=str, nargs='?')
    ...
    All_Searchable_Folders = [dirname("/media/quirky/EglintonData/lidar_data_sorting/LiDAR_Dual_Stage2/roundabout_straight/rosbag2_2025_02_12-14_18_54_0_21995-22580")]
    current_file = 10
    current_model = 0
    ...
    # try:
        ...
        front_lidar = np.delete(previous_data[0], -1, axis=1)
        # print(np.delete(data[0], -1, axis=1))
        # bleh
        rear_lidar = np.delete(previous_data[1], -1, axis=1)
