...
RESULTS_CSV = "sweep_results_mask.csv"      
LOG_DIR = "sweep_logs_mask"                  
FAILURES_CSV = "sweep_failures_mask.csv"      
...
POINTCAM_CHECKPOINT_PATH = "/media/ubuntu22/RAID1/jeremy/jeremybutson/pointcam/checkpoints/pointcam.pt"
...
SWEEP_LIST = [
    ...
    {**BASELINE, "run_label": "pretrained_frozen", "freeze_encoder": True,
     "pointcam_checkpoint_path": POINTCAM_CHECKPOINT_PATH},
    {**BASELINE, "run_label": "pretrained_frozen", "freeze_encoder": True,
     "pointcam_checkpoint_path": POINTCAM_CHECKPOINT_PATH},
    {**BASELINE, "run_label": "pretrained_frozen", "freeze_encoder": True,
     "pointcam_checkpoint_path": POINTCAM_CHECKPOINT_PATH},
    ...
    {**BASELINE, "run_label": "pretrained_frozen", "freeze_encoder": True,
     "pointcam_checkpoint_path": POINTCAM_CHECKPOINT_PATH},
    {**BASELINE, "run_label": "pretrained_finetuned", "freeze_encoder": False,
     "pointcam_checkpoint_path": POINTCAM_CHECKPOINT_PATH},
    {**BASELINE, "run_label": "pretrained_finetuned", "freeze_encoder": False,
     "pointcam_checkpoint_path": POINTCAM_CHECKPOINT_PATH},
    {**BASELINE, "run_label": "pretrained_finetuned", "freeze_encoder": False,
