...
bool python_nodes_interfaces__msg__float32_multi_array_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("python_nodes_interfaces.msg._float32_multi_array_stamped.Float32MultiArrayStamped", full_classname_dest, 81) == 0);
  }
  python_nodes_interfaces__msg__Float32MultiArrayStamped * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of Float32MultiArrayStamped */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("python_nodes_interfaces.msg._float32_multi_array_stamped");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Float32MultiArrayStamped");
